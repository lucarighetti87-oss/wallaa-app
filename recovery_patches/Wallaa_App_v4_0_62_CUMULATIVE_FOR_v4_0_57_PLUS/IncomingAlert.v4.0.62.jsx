...
function LiveMap({lat,lng,accuracy}){
  ...
  const data=useMemo(()=>{
    ...
    return {tiles,left:50+(p.x-cx)*256-128,top:50+(p.y-cy)*256-128};
  },[lat,lng]);
  ...
  return <div className="incoming-live-map" aria-label="Posizione SOS live">
    <div className="incoming-tile-grid" style={{transform:`translate(calc(-33.333% + ${128-(data.left-50)}px), calc(-33.333% + ${128-(data.top-50)}px))`}}>
